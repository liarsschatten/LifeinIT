...
Versionierung bedeutet, dass jede einzelne Version des Entwicklungsfortschritts behalten wird.
...
```
Einen Rebase macht man dahingegen nur, wenn man aufräumen will und sich sicher ist, dass man die Historie nicht mehr braucht.
```
git rebase
```
Good Practices
