...
Zu einer Beziehung gehört auch immer eine Kardinalitä,t also eine Angabe, wie diese in Relation stehen. Als Erklärung selbiges Beispiel: In einer Stadt wohnen viele Personen, aber eine Person wohnt nur in einer Stadt (Hauptwohnsitz). Das heißt, die Beziehung ist '*1 zu n*'. Das n steht immer da, wo die vielen sind, in diesem Beispiel wäre das die Person.
