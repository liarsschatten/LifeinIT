...
Für jede VM können separat Snapshots, sogenannte **'Checkpoints'** oder **'Prüfpunkte'** erstellt werden, um einen gewissen Stand einer VM zu sichern.
...
Suchen sie in Windows nach *Control Panel* oder *Systemsteuerung*
...
- Danach kann man die Generation auswählen, wobei Generation 2 die neuere und bessere Version ist (64 Bit statt 32 Bit).
